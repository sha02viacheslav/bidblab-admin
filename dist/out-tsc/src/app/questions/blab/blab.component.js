...
var BlabComponent = /** @class */ (function () {
    function BlabComponent(fb, socketsService, blockUIService, commonService, snackBar, authenticationService, dialogService, router) {
        this.fb = fb;
    ...
    BlabComponent.prototype.ngOnInit = function () {
    ...
    BlabComponent.prototype.ngOnDestroy = function () {
        if (this.isInit) {
            this.autocompleteSubscription.unsubscribe();
            this.socketEventsSubscription.unsubscribe();
        }
    };
    BlabComponent.prototype.initialize = function () {
        var _this = this;
        this.isInit = true;
        this.pageSize = 10;
        this.autocomplete = [];
    ...
    BlabComponent.prototype.searchBoxAction = function () {
    ...
    BlabComponent.prototype.isAuthenticated = function () {
        var _this = this;
    ...
    BlabComponent.prototype.openQuestionDialog = function (newTitle, question) {
        var _this = this;
        if (this.authenticationService.isAdmin()) {
            this.dialogService
    ...
    BlabComponent.prototype.openAnswerDialog = function (questionId, answer) {
        var _this = this;
        if (this.authenticationService.isAdmin()) {
            this.dialogService
    ...
    BlabComponent.prototype.getQuestions = function (event) {
        var _this = this;
        ...
        var observable = event
            ? this.commonService.getQuestionsCanAnswer(event.pageSize, event.pageIndex, this.form.value.search)
            : this.commonService.getQuestionsCanAnswer(null, null, this.form.value.search);
    ...
    BlabComponent.prototype.isAsker = function (questionId) {
    ...
    BlabComponent.prototype.isAdmin = function () {
        return this.authenticationService.isAdmin();
    };
    BlabComponent.prototype.canAnswer = function (questionId) {
        var _this = this;
        return (!this.authenticationService.getUser() ||
            !this.questions
    ...
    BlabComponent.prototype.listenToSocket = function () {
        var _this = this;
    ...
    BlabComponent.prototype.deleteQuestion = function (questionId) {
    ...
    return BlabComponent;
}());
exports.BlabComponent = BlabComponent;
//# sourceMappingURL=blab.component.js.map